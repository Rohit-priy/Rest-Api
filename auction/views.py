...
def Signup_User(request):
    ...
    if request.method == 'POST':
        ...
        Sign = User.objects.get(fname=f, lname=l, uname=u, email=e,
                                password=p, contact=con, address=add)
...
def Admin_Home(request):
    ...
    d = {'data': data, 'count': count, 'new2': new2,
...
def Change_Password(request):
    ...
    d = {'error': error, 'terror': terror,
         'data': sign, 'count': count, 'new2': new2}
...
def Edit_Category(request, pid):
    ...
    if request.method == 'POST':
        ...
        cat.save()
        error = True
    d = {'error': error, 'pro': pro, 'data': pro,
         'cat': cat, 'count': count, 'new2': new2}
...
def Edit_SubCategory(request, pid):
    ...
    if request.method == 'POST':
        ...
        subcat.save()
        error = True
    d = {'error': error, 'pro': pro, 'data': pro, 'cat': cat,
         'subcat': subcat, 'count': count, 'new2': new2}
...
def view_session_date(request):
    ...
    d = {'error': error, 'pro': pro, 'data': pro,
         'date1': cat, 'count': count, 'new2': new2}
...
def New_product(request):
    ...
    d = {'error': error, 'pro': pro, 'data': pro,
         'prod': prod, 'count': count, 'new2': new2}
...
def Edit_Session_time(request, pid):
    ...
    if request.method == 'POST':
        ...
        sett.save()
        error = True
    d = {'error': error, 'pro': pro, 'data': pro, 'sed': sed,
         'sett': sett, 'count': count, 'new2': new2}
...
def view_session_time(request):
    ...
    d = {'error': error, 'pro': pro, 'data': pro,
         'time1': cat, 'count': count, 'new2': new2}
...
def Add_Product(request):
    ...
    if request.method == "POST":
        ...
        pro1 = Product.objects.create(
            status=sta, session=ses, category=sub, name=p, max_price=pr, images=i)
        auc = Aucted_Product.objects.create(product=pro1, user=sell)
        terror = True
    d = {'sed': sed, 'sett': sett, 'cat': cat, 'scat': scat,
         'date1': date1, 'terror': terror, 'error': error}
...
def load_courses(request):
    ...
    courses = Sub_Category.objects.filter(
...
def Start_Auction(request, pid):
    ...
    d = {'pro': pro1, 'pro2': pro2, 'end2': end2,
...
def Change_status(request, pid):
    ...
    if request.method == "POST":
        ...
        terror = True
    d = {'pro': pro1, 'error': error, 'terror': terror,
         'data': data, 'count': count, 'new2': new2}
